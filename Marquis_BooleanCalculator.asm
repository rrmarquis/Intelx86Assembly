...
TITLE Marquis_BooleanCalculator
...
msgInteger1 BYTE "Enter a 4-byte hexadecimal integer:  ",0
msgInteger2 BYTE "Enter a second 4-byte hexadecimal integer: ",0
msgResult   BYTE "The 4-byte hexadecimal result is:            ",0
...
EntrySize = ($ - caseTable )
	...
	BYTE '5'
	DWORD ExitProgram
NumberOfEntries = ($ - caseTable) / EntrySize ; reset entry 
...
L1:	cmp al, [ebx]			; correct selection?
